# Configuración SSL A+ para tienda.lujandev.com
# /etc/nginx/sites-available/tienda.lujandev.com
...
server {
    ...
    # Document root
    root /var/www/ecommerce_deploy/ecommerce;
    index index.html index.htm;

    # SSL Certificate (Let's Encrypt)
    ssl_certificate /etc/letsencrypt/live/tienda.lujandev.com/fullchain.pem;
    ssl_certificate_key /etc/letsencrypt/live/tienda.lujandev.com/privkey.pem;
