...
export const sendEmail = async (saleId) => {
    console.log('🔍 [DEBUG sendEmail] ===== WRAPPER CALLED =====');
    console.log('🔍 [DEBUG sendEmail] saleId:', saleId);
    console.log('🔍 [DEBUG sendEmail] timestamp:', new Date().toISOString());
    
    await send_email(saleId);
    
    console.log('🔍 [DEBUG sendEmail] ===== WRAPPER EXITING =====');
};
